...
namespace automobiliai_su_db {
    ...
    public partial class DatabaseDataSet : global::System.Data.DataSet {
        ...
        public partial class CarsDataTable : global::System.Data.TypedTableBase<CarsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public CarsRow AddCarsRow(int Id, string Make, string Model, int Year, int Mileage) {
...
namespace automobiliai_su_db.DatabaseDataSetTableAdapters {
    ...
    public partial class CarsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Cars] WHERE (([Id] = @Original_Id) AND ([Make] = @Original_Mak" +
                "e) AND ([Model] = @Original_Model) AND ([Year] = @Original_Year) AND ([Mileage] " +
                "= @Original_Mileage))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Cars] ([Id], [Make], [Model], [Year], [Mileage]) VALUES (@Id, " +
                "@Make, @Model, @Year, @Mileage);\r\nSELECT Id, Make, Model, Year, Mileage FROM Car" +
                "s WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Cars] SET [Id] = @Id, [Make] = @Make, [Model] = @Model, [Year] = @Year, [Mileage] = @Mileage WHERE (([Id] = @Original_Id) AND ([Make] = @Original_Make) AND ([Model] = @Original_Model) AND ([Year] = @Original_Year) AND ([Mileage] = @Original_Mileage));
SELECT Id, Make, Model, Year, Mileage FROM Cars WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::automobiliai_su_db.Properties.Settings.Default.DatabaseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Make, Model, Year, Mileage FROM dbo.Cars";
        ...
        public virtual int Delete(int Original_Id, string Original_Make, string Original_Model, int Original_Year, int Original_Mileage) {
        ...
        public virtual int Insert(int Id, string Make, string Model, int Year, int Mileage) {
        ...
        public virtual int Update(int Id, string Make, string Model, int Year, int Mileage, int Original_Id, string Original_Make, string Original_Model, int Original_Year, int Original_Mileage) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Make, string Model, int Year, int Mileage, int Original_Id, string Original_Make, string Original_Model, int Original_Year, int Original_Mileage) {
            return this.Update(Original_Id, Make, Model, Year, Mileage, Original_Id, Original_Make, Original_Model, Original_Year, Original_Mileage);
        }
    }
